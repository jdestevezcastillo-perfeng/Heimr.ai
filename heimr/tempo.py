...
class TempoClient:
    ...
    def query_traces(self, min_duration: str = None, start_time: datetime = None, end_time: datetime = None, limit: int = 20) -> List[Dict[str, Any]]:
        """
    ...
    def get_slow_traces(self, start_time: datetime, end_time: datetime, min_duration_ms: int = 1000) -> List[Dict[str, Any]]:
        """
